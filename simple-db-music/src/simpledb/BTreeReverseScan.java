 ...
 */
public class BTreeReverseScan implements DbIterator {
    ...
    private Iterator<Tuple> reverseIt;
    ...
    public void open() throws DbException, TransactionAbortedException {
        ...
        while (it.hasNext()) {
            allTuples.add(0, it.next());
        }
        reverseIt = allTuples.iterator();
